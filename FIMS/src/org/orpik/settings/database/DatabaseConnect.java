...
public class DatabaseConnect extends javax.swing.JFrame {
            ...
            if (!dbServer.equals("")) {
                if (dbServer.equalsIgnoreCase("mysql")) {
                    ...
                    if (globalConnection == null) {
                        //Create connection when none exists
                        mysqlDatabaseConnection();
                       // System.out.println("New connection established to MySQL database server");
                    } else {
                        //System.out.println("Existing MySQL connection used");
                    }
                } else {
    ...
    /**
     * Auto commit is set to false, therefore, this method must be called to
